...
namespace Sample
{
    ...
    { 
        public float x; //x좌표
        public float y; //y좌표
        public float w; //width 폭
        public float h; //height 넓이
    }
    ...
    public class HitTest : MonoBehaviour
    {
        ...
        private bool CheckHitCircle(cCircle a, cCircle b)
        {
            ...
            //두원 사이의 거리가 두원의 반지름의 합보다 작으면 충돌이라고 판정 - 겹쳐짐
            if (distance <=(a.r +b.r))
            {
                return true;
            }
        ...
        //이동시 타겟까지의 남은 거리가 한 프레임에 이동하는 거리보다 작을때 충돌이라고 판정
